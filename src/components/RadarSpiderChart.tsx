...
import { DeputyTopicMetric } from '@core/types';
...
const RadarSpiderChart: React.FC<RadarSpiderChartProps> = ({ topics, size = 500 }) => {
  ...
  return (
    <div className="relative overflow-hidden rounded-[2rem] border border-[#d7c9ad] bg-gradient-to-br from-[#f9f4e8] via-[#f5efe1] to-[#efe7d7] p-6">
      <svg viewBox={`0 0 ${size} ${size}`} className="h-full w-full" role="img" aria-label={t('radar.ariaLabel')}>
        <defs>
