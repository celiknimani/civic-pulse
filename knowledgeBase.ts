...
export const PARTY_PROGRAMS_CONTEXT = `
OFFICIAL POLITICAL PLAN-PROGRAM DATA (2025 ELECTIONS):

1. LIDHJA DEMOKRATIKE E KOSOVËS (LDK) - "Rruga e Re" (Dec 2024):
- Economic Targets: 5% annual real growth, 5 billion EUR state budget, wage coefficient 150.
- Energy: 500MW gas plant, Gasification via North Macedonia, 500MW solar + 500MW wind. Zero VAT on energy.
- Technology: Ministry of Technology, 120M EUR Tech Fund, AI National Program (15M EUR), Angel Investor law.
- Social: 5000 EUR for 3rd child, New Ministry of Family, health insurance fund (3.5% + 3.5%).
- Infrastructure: Outer Ring Road of Pristina (250M EUR), 200 regional bus stops, Railway Xërxe-Prizren.
- Justice: Two-stage Vetting (Constitutional then Legislative), Specialized State Investigation Center.

2. ALEANCA PËR ARDHMËRINË E KOSOVËS (AAK) - Coalition with Nisma, Conservative List, E30:
- Security/NATO: Main pillar is direct NATO membership. 1 billion EUR military budget over 4 years.
- Economic Targets: 7% annual GDP growth, 1.1-1.5 billion EUR annual public investment. 
- Wages: Minimum wage 500 EUR, Average wage 1000 EUR.
- Social: 300 EUR monthly for families with no employed members. Veterans can work without losing benefits.
- Environment: 100M EUR for irrigation, 5 new dams (Firajë, Pollatë, Kuqicë, Dragaçinë, Desivojcë).
