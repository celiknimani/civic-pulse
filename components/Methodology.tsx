      ...
      <div className="space-y-16">
        <header className="space-y-6">
          ...
          <h2 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tight">
            Si funksionon <span className="text-blue-600">zotimet.com</span>?
          </h2>
        ...
        <section className="bg-blue-600 rounded-[2.5rem] p-8 md:p-12 text-white space-y-6 shadow-2xl shadow-blue-500/20">
          ...
          <p className="text-blue-100 font-medium leading-relaxed opacity-90">
            zotimet.com është një mjet informues dhe jo këshillues. Edhe pse AI bën punë të shkëlqyer në analizë, ne ju inkurajojmë të klikoni mbi "Burimet e Verifikuara" në çdo analizë për të lexuar tekstin origjinal të planprogrameve politike.
          </p>
          <button 
            onClick={onBack}
            className="bg-white text-blue-600 px-8 py-4 rounded-2xl font-black uppercase tracking-widest text-xs hover:bg-blue-50 transition-all active:scale-95"
          >
            Filloni Krahasimin
          </button>
        </section>
